...
describe('CreditCard', () => {
  ...
  describe('#validate()', () => {
    it('no invalid responses on valid card', () => {
      const card = {
        cardType: 'VISA',
    ...
    it('validates a card using a custom schema', () => {
      const schema = {
        cardType: 'type',
        number: 'number',
    ...
    it('no invalid responses on valid card by alias', () => {
      const card = {
        cardType: 'VC',
        number: '4111111111111111',
        expiryMonth: '03',
    ...
    it('invalid responses on invalid card', () => {
      const card = {
        cardType: 'VISA',
    ...
    it('invalid responses on no card', () => {
    ...
    it('provides custom validation function', () => {
      const card = {
        cardType: 'VISA',
        number: '4111111111111111',
        expiryMonth: '03',
  ...
  describe('#determineCardType()', () => {
    it('successfully detects full numbers', () => {
    ...
    it('successfully detects partial numbers if allowPartial is true', () => {
    ...
    it('does not allow partial matches if allowPartial is false', () => {
  ...
  describe('#isValidCardNumber()', () => {
    ...
    it('returns false for numbers that pass luhn but fail are invalid', () => {
      expect(CreditCard.isValidCardNumber('123', 'AMERICANEXPRESS')).to.equal(false);
    });
  });

  describe('#doesNumberMatchType()', () => {
    it('returns true for valid card matches', () => {
    ...
    it('returns true for custom card types', () => {
  ...
  describe('#doesCvvMatchType()', () => {
    it('returns true for valid cvv matches', () => {
    ...
    it('returns false for invalid cvvs', () => {
  ...
  describe('#isValidExpiryMonth()', () => {
    it('returns true for valid month', () => {
    ...
    it('returns true for month in specified range', () => {
  ...
  describe('#isValidExpiryYear()', () => {
    ...
    it('returns true for year in specified range', () => {
  ...
  describe('#isExpired()', () => {
    it('returns true for an expired card', () => {
      expect(CreditCard.isExpired(12, 2013)).to.equal(true);
    });

    it('returns false for non-expired card', () => {
      expect(CreditCard.isExpired(1, 2100)).to.equal(false);
    });

    it('returns true when card expired last month', () => {
      const date = new Date();
    ...
    it('returns false when card expires this month', () => {
      const date = new Date();
  ...
  describe('#sanitizeNumberString()', () => {
    it('returns a string stripped of all non-numeric characters', () => {
  ...
  describe('#defaults()', () => {
    ...
    it('makes no changes without arguments', () => {
      const original = CreditCard.reset();
      const updated = CreditCard.defaults();
    ...
    it('overwrites when second argument is true', () => {
      const updated = CreditCard.defaults({}, true);

      expect(updated).to.equal({});
    });

    it('does not overwrite when second argument is false', () => {
      const original = CreditCard.reset();
  ...
  describe('#reset()', () => {
    it('resets to original defaults', () => {
      const original = CreditCard.reset();
      const updated = CreditCard.defaults({}, true);
